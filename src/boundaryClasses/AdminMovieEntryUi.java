...
public class AdminMovieEntryUi extends AdminMainUi {
	...
	/**
	 * display Movie manager page that redirect to page that creates/update
	 * movie entry and sort movie by rating or ticket sales
	 * 
	 * @throws IOException
	 ...
	 * @throws ParseException
	 */
	public static void displayMovieCreatePage() throws IOException,
			ParseException {
		Scanner sc = new Scanner(System.in);
		...
		do {
			System.out
					.println("Please choose whether movie is a 3D movie or not?");
			System.out.println("1.No");
			System.out.println("2.Yes");
			choice = ValidationControl.validateYesNoAndReturnIntegerValue(sc
					.nextLine());
		...
		do {
			System.out
					.println("Please choose whehter movie is a blockbuster or not?");
			System.out.println("1.No");
			System.out.println("2.Yes");
			choice = ValidationControl.validateYesNoAndReturnIntegerValue(sc
					.nextLine());
	 ...
	 * @throws ParseException
	 */
	public static void displayMovieUpdatePage() throws IOException,
			ParseException {
		Scanner sc = new Scanner(System.in);
		int choice = 0;
		ValidationControl vl = new ValidationControl();
		...
		do {
			...
			System.out.println();
			System.out.println(movieList.size() + 1
					+ ":Go to Movie Manager Page");
