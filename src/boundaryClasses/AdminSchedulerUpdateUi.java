...
public class AdminSchedulerUpdateUi extends AdminSchedulerMainUi{
	 ...
	 * @throws ParseException
	 */
	public static void displayUpdatePageDetails(MovieSchedule sch, Movie movie,int cineId) throws IOException, ParseException
	{
		...
		System.out.println("Start date:"+new SimpleDateFormat("dd/MM/yyyy HH:mm").format(sch.getStartDate()));
		System.out.println("End date:"+new SimpleDateFormat("dd/MM/yyyy HH:mm").format(sch.getEndDate())+"\n");
		System.out.println("-------------------------------------");
	...
	public static void displayEditExistingTimeSlot(MovieSchedule movieSchedule,int movieId,int cineId, Movie movie) throws IOException, ParseException{
		...
		int run=TimeDateControl.calculateRunDate(movieSchedule.getStartDate(), movieSchedule.getEndDate())+1;
		...
		else if(choice3==2)
		{
			...
			do{
				...
				System.out.println();
				 select=ValidationControl.validateAndReturnIntegerValue(sc.nextLine());
 ...
 */
	public static void displayUpdateTimeSlot(ArrayList<ObjectContainer> pair, int choice,MovieSchedule movieSchedule, Movie movie,int cineId) throws IOException, ParseException {
		...
		if(choice2==2)
		{
			...
			AdminShowTimeController.timeSlotHandler("add",cineId,tmpSch , movie.getMovieId(), movie.getMovieLength(), movie.getMovieType(), 1,movie);
		}
