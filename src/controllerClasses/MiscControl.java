...
public class MiscControl {
	...
	public static ObjectContainer idPairerWithCinema(int i, int id,
			String name, int cineType, int seatNo) {
	...
	public static ObjectContainer idPairerWithMovieLength(int i, int id,
			int len, int movieType, int j, Movie movie) {
