...
public class TimeDateControl {
	...
	/**
	 * Calculate how long a movie is showing based on starting date and ending
	 * date
	 * 
	 * @param sD
	 *            Start Date
	...
	/**
	 * Calculate the time range a movie will be showing by taking in the
	 * starting date and adding the movie length.
	 * 
	 * @param minutes
	 *            movie length
	 * @param sD
	...
	/**
	 * Given a start date and how long a movie will be showing, calculate the
	 ...
	 */
	public static Date calculateEndDate(Date startDate, int runDate)
			throws ParseException {
