...
public class MovieListingControl extends DataControl {
	...
	public static ArrayList<Movie> retrieveUniqueMovieListFromSchedule(ArrayList<MovieSchedule>schList) throws IOException, ParseException
	{
		...
		{
			if(schList.get(i).getPlatOrNot()==1)
			{
