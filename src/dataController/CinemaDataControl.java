...
public class CinemaDataControl extends DataControl {
	...
	public static ArrayList<Cinema> readCinema() throws IOException {
		...
		for (int i = 0; i < stringArray.size(); i++) {
			...
			Cinema u = new Cinema(cineplexId, cinemaId, cinemaName, cinemaType,
					seats);
			// add to list
			alr.add(u);
	...
	public static Cinema readCinemaByCinemaId(int cId) throws IOException {
		...
		for (int i = 0; i < stringArray.size(); i++) {
			...
			if (cinemaId == cId) {
				Cinema u = new Cinema(cineplexId, cinemaId, cinemaName,
						cinemaType, seats);
				// add to list
				return u;
			}
	 ...
	 * @throws IOException
	 */
	public static ArrayList<Cinema> readCinemaByCineplexId(int cId)
			throws IOException {
