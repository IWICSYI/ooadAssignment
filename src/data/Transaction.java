...
/**
 * Transaction object to print receipt. Contains reference to seats information,
 * cinema, movie and cineplex via their IDs.
 * 
 * @author Chang En Kai
 *
 */
public class Transaction {
	...
	public Transaction(String transcationId, String email, String mobilePhone,
			String custName, int age, int cineplexId, int cinemaId, int movie,
			double price2) {
		super();
		this.transcationId = transcationId;
		this.email = email;
	...
	public void printTranscation() throws IOException {
		...
		Cineplex c = CineplexDataControl
				.readCineplexBasedonCinplexId(cineplexId);
