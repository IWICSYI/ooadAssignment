...
public class SeatsInformation {
	...
	public SeatsInformation(Date startDate, String startEndTime,
			int seatInfoId, int noOfSeats, int noOfEmptySeats, int movieId,
			int cinemaId, int cineplexId, int showTimeId, double price) {
		super();
