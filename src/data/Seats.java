...
/**
 * Seat object, contain reference to transcation and seat formation by their
 * respective IDs.
 * 
 * @author Chang En Kai
 *
 */
public class Seats implements Comparator<Seats>{
	...
	public int compare(Seats o1, Seats o2) {
		return o1.getSeatName().compareTo(o2.getSeatName());
